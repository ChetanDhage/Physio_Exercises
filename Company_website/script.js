...
function setupPackageButtons() {
    ...
    packageButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const packageType = this.textContent.trim().toLowerCase().replace('-', '');
...
function setupViewAllButton() {
    ...
    if (viewAllButton) {
        // Set the View All button to point to all-exercises.html
        viewAllButton.href = 'all-exercises.html';
